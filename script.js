...
function generateChart() {
    ...
    // NOTE: This will fail if you just double-click index.html (CORS error).
    // You MUST use a local server (like Live Server extension in VS Code).
    Papa.parse('investment_data.csv', {
        download: true, // TRUE because we are fetching a file
        header: true,
        dynamicTyping: true,
        delimiter: ";", // Ensure this matches your CSV format (semicolon or comma)
        complete: (result) => {
